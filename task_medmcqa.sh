...
RUN_NAME=${RUN_NAME:-llama-3-1-8b-${METHOD}-qkvogateupdown-rank${RANK}-medmcqa-full-outputonly-epoch${NUM_TRAIN_EPOCHS}-loraopt${LORA_OPTIMIZER_DTYPE}-loralr${LORA_LR}}
