...
MODULE_LR=1e-5 \
LORA_DROPOUT=0.0 \
RUN_NAME=gemma-3-1b-pt-seq-dynamic_random-qkvogateupdown-rank32-synthetic-text-to-sql-full-outputonly-epoch1-ratio0.026095-block50-seed0-loraoptbf16-moduleoptfp32-resetoffload-loralr1e-4-modulelr1e-5 \
