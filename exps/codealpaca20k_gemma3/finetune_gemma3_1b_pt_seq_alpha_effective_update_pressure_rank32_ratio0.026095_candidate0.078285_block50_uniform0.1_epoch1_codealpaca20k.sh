...
OUTPUT_ROOT=/mnt/dhwfile/raise/user/caojie/loraplusMSeq/outputs/codealpaca20k-gemma-3-1b-pt \
METHOD=alpha \
...
LORA_LR=1e-4 \
MODULE_LR=1e-5 \
RUN_NAME=gemma-3-1b-pt-seq-alpha-effective-update-pressure-candidate0.078285-uniform0.1-qkvogateupdown-rank32-codealpaca20k-epoch1-ratio0.026095-block50-seed0-loraoptbf16-moduleoptfp32-resetoffload-loralr1e-4-modulelr1e-5 \
...
TEST_BATCH_SIZE=${TEST_BATCH_SIZE:-164} \
