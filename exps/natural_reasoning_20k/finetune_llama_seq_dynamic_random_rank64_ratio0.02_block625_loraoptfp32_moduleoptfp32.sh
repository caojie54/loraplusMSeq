...
LORA_OPTIMIZER_DTYPE=fp32 \
MODULE_OPTIMIZER_DTYPE=fp32 \
MODULE_GRADIENT_MODE=full \
MODULE_OPTIMIZER_STATE_STRATEGY=reset_offload \
RUN_NAME=llama-3-1-8b-seq-dynamic_random-qkvogateupdown-rank64-natural-reasoning-20k-epoch1-ratio0.02-block625-loraoptfp32-moduleoptfp32-resetoffload-loralr1e-4-modulelr1e-5 \
