...
RUN_NAME=llama-3-1-8b-seq-alpha-effective-update-pressure-candidate0.09-uniform0.1-qkvogateupdown-rank96-natural-reasoning-20k-epoch1-ratio0.03-block50-seed1-loraoptbf16-moduleoptfp32-resetoffload-loralr1e-4-modulelr1e-5 \
