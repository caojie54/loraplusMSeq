...
RUN_NAME=llama-3-1-8b-seq-alpha-effective-update-pressure-qkvogateupdown-rank64-natural-reasoning-20k-epoch1-ratio0.02-block50-seed1-loraoptbf16-moduleoptfp32-resetoffload-loralr1e-4-modulelr1e-5 \
