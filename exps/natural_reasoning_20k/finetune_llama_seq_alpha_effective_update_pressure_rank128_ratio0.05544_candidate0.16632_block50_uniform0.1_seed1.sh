...
RUN_NAME=llama-3-1-8b-seq-alpha-effective-update-pressure-candidate0.16632-uniform0.1-qkvogateupdown-rank128-natural-reasoning-20k-epoch1-ratio0.05544-block50-seed1-loraoptbf16-moduleoptfp32-resetoffload-loralr1e-4-modulelr1e-5 \
