...
RUN_NAME=llama-3-1-8b-seq-alpha-gradnorm-pressure-qkvogateupdown-rank64-natural-reasoning-20k-epoch1-ratio0.02-block20-loraoptbf16-moduleoptfp32-resetoffload-loralr1e-4-modulelr1e-5 \
