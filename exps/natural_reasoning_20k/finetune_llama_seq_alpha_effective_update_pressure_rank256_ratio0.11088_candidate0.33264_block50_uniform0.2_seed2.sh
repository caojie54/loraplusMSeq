...
RUN_NAME=llama-3-1-8b-seq-alpha-effective-update-pressure-candidate0.33264-uniform0.2-qkvogateupdown-rank256-natural-reasoning-20k-epoch1-ratio0.11088-block50-seed2-loraoptbf16-moduleoptfp32-resetoffload-loralr1e-4-modulelr1e-5 \
