...
COMP_RATIO=0.02 \
SELECTION_INTERVAL=125 \
LORA_OPTIMIZER_DTYPE=bf16 \
MODULE_OPTIMIZER_DTYPE=fp32 \
MODULE_GRADIENT_MODE=residual \
MODULE_OPTIMIZER_STATE_STRATEGY=reset_offload \
RUN_NAME=llama-3-1-8b-seq-alpha-gradnorm-pressure-qkvogateupdown-rank64-natural-reasoning-20k-epoch1-ratio0.02-block125-loraoptbf16-moduleoptfp32-resetoffload-modulegradres-loralr1e-4-modulelr1e-5 \
