...
MODULE_OPTIMIZER_STATE_STRATEGY=reset \
NUM_TRAIN_EPOCHS=1 \
...
RUN_NAME=llama-3-1-8b-seq-dynamic_random-qkvogateupdown-rank64-natural-reasoning-20k-epoch1-ratio0.02-block625-loralr1e-4-modulelr1e-5 \
