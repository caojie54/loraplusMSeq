...
LORA_LR=1e-4
MODULE_LR=1e-5
RUN_NAME=gemma-3-4b-pt-seq-alpha-effective-update-pressure-candidate0.16632-uniform0.3-qkvogateupdown-rank128-natural-reasoning-20k-epoch1-ratio0.05544-block50-seed2-loraoptbf16-moduleoptfp32-resetoffload-loralr1e-4-modulelr1e-5
MAX_LENGTH=1536
TRAIN_BATCH_SIZE=4
