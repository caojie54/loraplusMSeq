...
RUN_NAME=gemma-4-E2B-seq-alpha-effective-update-pressure-candidate0.08-uniform0.1-qkvogateupdown-rank64-natural-reasoning-20k-epoch1-ratio0.02-block50-seed2-loraoptbf16-moduleoptfp32-resetoffload-loralr1e-4-modulelr1e-5 \
